...
elsif File.exists?(File.expand_path('../../Rakefile_conf.rb', File.dirname(__FILE__))) then
  # found in the upper project
  require_relative '../../Rakefile_conf.rb'
elsif File.exists?(File.expand_path('../../cmake_utils/Rakefile_conf.rb', File.dirname(__FILE__))) then
  # found in the upper project under cmake_utils
  require_relative '../../cmake_utils/Rakefile_conf.rb'
else
  #-------------------------
  COMPILE_DEBUG      = false
